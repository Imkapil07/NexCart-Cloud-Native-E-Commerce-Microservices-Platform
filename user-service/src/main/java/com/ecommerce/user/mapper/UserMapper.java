...
/**
 * Maps between User entity and DTOs; encodes password when creating
 * entity from registration request.
 **/
@Component
public class UserMapper {
    ...
    /**
     * Converts registration DTO to entity with encoded password
     * and default ROLE_USER.
     **/
    ...
    /**
     * Converts entity to response DTO (no password).
     **/
